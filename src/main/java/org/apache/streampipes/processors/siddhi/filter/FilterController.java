...
public class FilterController extends StandaloneEventProcessingDeclarer<FilterParameters> {
	...
	public DataProcessorDescription declareModel() {
		return ProcessingElementBuilder.create("org.apache.streampipes.processors.siddhi.filter")
	...
	@Override
	public ConfiguredEventProcessor<FilterParameters> onInvocation(DataProcessorInvocation graph, ProcessingElementParameterExtractor extractor) {
		...
		FilterParameters staticParam = new FilterParameters(graph, threshold, FilterOperator.valueOf
				(operation)
				, filterProperty);

		return new ConfiguredEventProcessor<>(staticParam, Filter::new);
	}
